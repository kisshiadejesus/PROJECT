...
import aboutMe from '../../assets/aboutme.jpeg'; // You might need this
// Create this file for DeJesusPage specific styles

function DeJesusPage() {
  const showNewArrivalsBanner = false; // You can set this dynamically if needed
  ...
  return (
    <>
      ...
      <div className="main-content-container" style={{
        ...
        backgroundImage: `url(${aboutMe})`, // You might not have this image in this component
